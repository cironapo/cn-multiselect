...
const CnMultiselect = class {
    ...
    */
    ...
    render() {
        ...
        return (h("div", { key: '8438078858896c62e83bc3ae4b0f5f9308d2f7c5', class: css_class }, this.popup
            ? h("div", { class: this.open ? 'overlay show' : 'overlay' })
            : '', h("div", { key: '255253e68a788c7735837cb8b9fd96655db45ef9', class: "cn-selected-options", onClick: () => this.toggleOptions(), onDrop: event => this.drop(event), onDragOver: event => this.allowDrop(event), onDragEnd: event => this.dragEnd(event) }, selected), h("div", { key: '4a35b8082705ffca3959becf352d2c7428ca5001', class: "container-options" }, h("div", { key: '916e295ae5f087840870487528d8d8903e4d1386', class: open_options }, this.popup
            ? h("div", { class: "popup-header" }, h("span", { class: "title" }, this.popupTitle), h("span", { class: "close", onClick: () => this.toggleOptions() }))
            : '', h("div", { key: '2733779fb8aefbe87afc92ac635fb79313794027', class: "content-options" }, search, h("div", { key: '7153b20927535f087b32df70b16703da16487ef1', class: "list-options" }, h("div", { key: '03c6d0b6bc4fdc037f27755a5a6a55d091f678d5', class: this.search ? 'options-list' : 'options-list no-search' }, options))), this.selectAll ?
