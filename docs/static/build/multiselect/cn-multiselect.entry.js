...
const CnMultiselect = class {
    ...
    render() {
        ...
        return (h("div", { key: 'd0ada4c8f9b57844019883e73b2435806a3942ae', class: css_class }, this.popup
            ? h("div", { class: this.open ? 'overlay show' : 'overlay' })
            : '', h("div", { key: 'b78e7ddf529a77f0742d1e655fa2952c095a50b8', class: "cn-selected-options", onClick: () => this.toggleOptions(), onDrop: event => this.drop(event), onDragOver: event => this.allowDrop(event), onDragEnd: event => this.dragEnd(event) }, selected), h("div", { key: '869eb8c607519dc0a8b77ce8a4d743610a42704a', class: "container-options" }, h("div", { key: '2cdf65e9b2fc4fd90f44236630cc9b6f400b965f', class: open_options }, this.popup
            ? h("div", { class: "popup-header" }, h("span", { class: "title" }, this.popupTitle), h("span", { class: "close", onClick: () => this.toggleOptions() }))
            : '', h("div", { key: '606e04f0ab9b736caffcc289f96f86efd7841c08', class: "content-options" }, search, h("div", { key: 'e3b9f730c49e06d65c94c8f0a41f831eb06b3711', class: "list-options" }, h("div", { key: '46d09f02bf4eb7c6bfce4d3fdea1215e4edc1d62', class: this.search ? 'options-list' : 'options-list no-search' }, options))), h("div", { key: 'd25b9b76e70c69f6dcd2d8d1cca5faedc9408951', class: "bulks" }, h("button", { key: '3a2c04e75028aff30df691bd88b2de700c8ff24a', onClick: () => this.selectAllItems() }, this.selectAllText), h("button", { key: '3b2e849805d48753dd52dc88e0199510e5d83366', onClick: () => this.deselectAllItems() }, this.deselectAllText))))));
    }
        ...
        if (this._selected && this._selected.length > 0 && this._options && this._options.length > 0) {
            return this._selected.map(option => {
                ...
                if (selected) {
                    ...
                    return h("div", { class: "cn-selected-option", style: style, "data-key": selected.key, draggable: true, onDragStart: event => this.drag(event), onClick: event => this.clickItem(selected, event) }, h("span", null, selected.value), h("span", { class: "cn-btn-delete-option", onClick: event => this.deselected(selected, event) }));
                }
            });
        }
            ...
            const filteredOptions = this._options.map(option => {
                if (this.search && this.searchKey && this.searchKey.length > 2 && !option.value.toLowerCase().match(new RegExp(this.searchKey.toLowerCase()))) {
                    ...
                    return h("div", { class: disabled ? "cn-option disabled" : "cn-option" }, h("label", { class: "pure-material-checkbox" }, checked
                        ...
                        : h("input", { type: "checkbox", onChange: event => this.toggle(option, event) }), h("span", null, h("div", null, option.value))));
                }
            });
