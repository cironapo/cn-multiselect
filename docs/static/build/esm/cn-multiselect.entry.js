    ...
    */
    ...
    render() {
        ...
        return (h("div", { key: '1b969bad8c907451919d15412a96d8a059d13c66', class: css_class }, this.popup
            ...
            : '', h("div", { key: 'ae5ca5acc290e898f2e9ed1b1c9b60a9d1893288', class: "cn-selected-options", onClick: () => this.toggleOptions(), onDrop: event => this.drop(event), onDragOver: event => this.allowDrop(event), onDragEnd: event => this.dragEnd(event) }, selected), h("div", { key: 'd8e74967c1d80344d846bd2354b0f77588087cf6', class: "container-options" }, h("div", { key: '7a3f929a884a737d2ec353833ce76c4e0fd80587', class: open_options }, this.popup
            ? h("div", { class: "popup-header" }, h("span", { class: "title" }, this.popupTitle), h("span", { class: "close", onClick: () => this.toggleOptions() }))
            : '', h("div", { key: '2ff0b99675a9fa8b72f000b7a71b7ff8e4ab6b20', class: "content-options" }, search, h("div", { key: 'da861539e268a34b3d5c27d046f05058f8c87306', class: "list-options" }, h("div", { key: '13a405eec284aadf35fe68d7b1b1822f3470e50e', class: this.search ? 'options-list' : 'options-list no-search' }, options))), (this.selectAll && this.multiple) ?
