...
const CnMultiselect = class {
    ...
    */
    ...
    render() {
        ...
        return (index.h("div", { key: 'e96925eebac046b1ebca8c2722853cd994807e6a', class: css_class }, this.popup
            ? index.h("div", { class: this.open ? 'overlay show' : 'overlay' })
            : '', index.h("div", { key: '153fd515b3d91bc83a5eddd06a4de78623651b89', class: "cn-selected-options", onClick: () => this.toggleOptions(), onDrop: event => this.drop(event), onDragOver: event => this.allowDrop(event), onDragEnd: event => this.dragEnd(event) }, selected), index.h("div", { key: '8dd38f9ba3ea7fd5863ce43885f3e863ef403476', class: "container-options" }, index.h("div", { key: '6ac2c6a1f965335c09771b6a49baa14c080ec982', class: open_options }, this.popup
            ...
            : '', index.h("div", { key: '9e71f8edf7e38d03013611482847de7a1750b8a4', class: "content-options" }, search, index.h("div", { key: 'e6bf691e671f664acf53d416f6155f753c370eb0', class: "list-options" }, index.h("div", { key: 'c6c5362523f70337af3215563293f9ae22e73d59', class: this.search ? 'options-list' : 'options-list no-search' }, options))), this.selectAll ?
