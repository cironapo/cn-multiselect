import { r as registerInstance, c as createEvent, h, g as getElement } from './index-1da239bf.js';
...
const CnMultiselect = class {
    ...
    */
    ...
    render() {
        ...
        return (h("div", { key: '1b969bad8c907451919d15412a96d8a059d13c66', class: css_class }, this.popup
            ? h("div", { class: this.open ? 'overlay show' : 'overlay' })
            : '', h("div", { key: '866f7a9af690d75007a38b9c0e3a8596301ef58a', class: "cn-selected-options", onClick: () => this.toggleOptions() }, selected), h("div", { key: '1289d16bf4537fd43e4fc2c33885ed1ecabe754d', class: "container-options" }, h("div", { key: 'fb3048fb302adfb19eb81341799f3ef912bc93a9', class: open_options }, this.popup
            ? h("div", { class: "popup-header" }, h("span", { class: "title" }, this.popupTitle), h("span", { class: "close", onClick: () => this.toggleOptions() }))
            : '', h("div", { key: '5d252e583a974eb8a735d8a9def646bb251af415', class: "content-options" }, search, h("div", { key: '7859450bcda3fe1d01164f89f0ce3cfcb4186d65', class: "list-options" }, h("div", { key: '1e1e00056f607ddc08b2caf3f2d51962f1a623dd', class: this.search ? 'options-list' : 'options-list no-search' }, options))), (this.selectAll && this.multiple) ?
            ...
            if (this.preserveOrder) {
                return this._options.map(option => {
                    if (this._selected.includes(option.value)) {
                        ...
                        return h("div", { class: "cn-selected-option", style: style, "data-key": option.value, onClick: event => this.clickItem(option, event) }, h("span", null, option.label), h("span", { class: "cn-btn-delete-option", onClick: event => this.deselected(option, event) }));
                    }
                });
            }
            else {
                return this._selected.map(option => {
                    ...
                    if (selected) {
                        ...
                        return h("div", { class: "cn-selected-option", style: style, "data-key": selected.value, onClick: event => this.clickItem(selected, event) }, h("span", null, selected.label), h("span", { class: "cn-btn-delete-option", onClick: event => this.deselected(selected, event) }));
                    }
                });
            }
        }
